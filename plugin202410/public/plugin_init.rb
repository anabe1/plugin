  ...
  #    'sort' => 'title_sort asc',
    ...
    def search
      ...
      begin
         ...
         #Create Filter_fields and Filter_values for selected repositories
         filterValues0='/repositories/5'
         filterValues1='/repositories/6'
         filterFields='repository';
        
         if params[:limit] == filterValues0
            params[:limit] =""
            params[:filter_fields]=[filterFields]
            params[:filter_values]=[filterValues0]
         end 
                 
         if params[:limit] == filterValues1
            params[:limit] =""
            params[:filter_fields]=[filterFields]
            params[:filter_values]=[filterValues1]
         end
